const servicos = [
    ...
    },
    {
        ...
        servico: 'Seguros',
        texto: `A FacileCred possui <strong>todos os tipos de seguros</strong> e <strong>mais de 10 seguradoras</strong> parceiras para melhor atender sua necessidade!`
    },
    {
        imagem: `assets/servicos/consorcio.jpg`,
        servico: 'Consórcios',
        texto: `A FacileCred oferece a <strong>melhor opção de consórcio</strong> de acordo com sua necessidade. Trabalhamos com todos os tipos de consórcios!`
    },
    {
    ...
    },
    {
        ...
        texto: `Está na hora de adquirir seu <strong>novo veículo</strong>! Com a FacileCred você tem as <strong>melhores taxas</strong> e opções de financiamento!`
    },
    {
        imagem: `assets/servicos/casa.jpg`,
        servico: 'Financiamento Residencial',
        texto: `Está na hora de adquirir sua <strong>nova casa</strong>! Com a FacileCred você tem as <strong>melhores taxas</strong> e opções de financiamento, refinanciamento e carta fiança!`
    },
    {
        imagem: `assets/servicos/conta.jpg`,
        servico: 'Abertura de conta',
        texto: `Abra sua conta bancária <strong>sem custo</strong>! Com a FacileCred você tem os <strong>melhores bancos</strong> para abrir sua conta bancária digital!`
    },
    {
    ...
    },
    {
        ...
        texto: `A FacileCred oferece <strong>diversas opções de maquininha de cartão</strong> com as <strong>melhores taxas</strong> do mercado! `
    },
];
